/**
 * Admin API client (Phases 7-14 complete)
 */
...
// ===== Phase 10: Export Logs =====
export async function exportAuthLogs(idToken, sessionToken, filters = {}) {
  return postBlob('/api/admin/logs/auth/export', { idToken, sessionToken, payload: filters }, 'auth-logs.csv');
}
export async function exportAuditLogs(idToken, sessionToken, filters = {}) {
  return postBlob('/api/admin/logs/audit/export', { idToken, sessionToken, payload: filters }, 'audit-logs.csv');
}
export async function exportAccessLogs(idToken, sessionToken, filters = {}) {
  return postBlob('/api/admin/logs/access/export', { idToken, sessionToken, payload: filters }, 'access-logs.csv');
}
...
// ===== Phase 13: Analytics =====
export async function getAnalyticsOverview(idToken, sessionToken, days = 30) {
  return post('/api/admin/analytics/overview', { idToken, sessionToken, payload: { days } });
}
export async function getDailyAccess(idToken, sessionToken, days = 30) {
  return post('/api/admin/analytics/dailyAccess', { idToken, sessionToken, payload: { days } });
}
export async function getTopDocuments(idToken, sessionToken, days = 30, limit = 10) {
  return post('/api/admin/analytics/topDocuments', { idToken, sessionToken, payload: { days, limit } });
}
export async function getRegistrations(idToken, sessionToken, days = 30) {
  return post('/api/admin/analytics/registrations', { idToken, sessionToken, payload: { days } });
}
export async function getLoginActivity(idToken, sessionToken, days = 7) {
  return post('/api/admin/analytics/loginActivity', { idToken, sessionToken, payload: { days } });
}
export async function getCategoryUsage(idToken, sessionToken, days = 30) {
  return post('/api/admin/analytics/categoryUsage', { idToken, sessionToken, payload: { days } });
}
export async function getTopUsers(idToken, sessionToken, days = 30, limit = 10) {
  return post('/api/admin/analytics/topUsers', { idToken, sessionToken, payload: { days, limit } });
}

// ===== Phase 14: Notifications =====
export async function getNotificationSettings(idToken, sessionToken) {
  return post('/api/admin/notifications/settings', { idToken, sessionToken });
}
export async function updateNotificationSettings(idToken, sessionToken, settings) {
  return post('/api/admin/notifications/update', { idToken, sessionToken, payload: settings });
}
export async function testNotification(idToken, sessionToken) {
  return post('/api/admin/notifications/test', { idToken, sessionToken });
}
export async function getNotificationRecipients(idToken, sessionToken) {
  return post('/api/admin/notifications/recipients', { idToken, sessionToken });
}
