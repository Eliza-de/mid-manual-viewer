/**
 * Analytics — Phase 17 STUB
 *
 * TODO: Replace with V2 page from src/pages/Analytics.jsx
 * (Adapt API calls: apiCall → adminAnalytics* from ../api/admin)
 */
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: MINT_MUTED }}>
            7 charts (Recharts) - views, downloads, users
          </div>
        </div>
