/**
 * UserManagement — Phase 17 STUB
 *
 * TODO: Replace with V2 page from src/pages/UserManagement.jsx
 * (Adapt API calls: apiCall → adminUser* from ../api/admin)
 */
      ...
      <div style={{
        ...
        <div style={{
          ...
          หน้านี้จะถูก replace ด้วย V2 page จาก <code style={{
            ...
            fontSize: 12,
            color: MINT_DARK,
          }}>src/pages/UserManagement.jsx</code>
        </div>
        ...
        <div style={{
          ...
          <div style={{ color: MINT_MUTED }}>
            List, approve, edit roles, lock/unlock PIN
          </div>
        </div>
