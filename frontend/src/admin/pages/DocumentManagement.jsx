/**
 * DocumentManagement — Phase 17 STUB
 *
 * TODO: Replace with V2 page from src/pages/DocumentManagement.jsx
 * (Adapt API calls: apiCall → adminDocument* from ../api/admin)
 */
...
export default function DocumentManagement({ user, onNavigate }) {
  return (
    <div>
      {/* Header */}
      <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          หน้านี้จะถูก replace ด้วย V2 page จาก <code style={{
            ...
            fontSize: 12,
            color: MINT_DARK,
          }}>src/pages/DocumentManagement.jsx</code>
        </div>
        ...
        <div style={{
          ...
          <div style={{ color: MINT_MUTED }}>
            Upload, replace pages, delete, edit metadata
          </div>
        </div>
