/**
 * NotificationSettings — Phase 17 STUB
 *
 * TODO: Replace with V2 page from src/pages/NotificationSettings.jsx
 * (Adapt API calls: apiCall → adminNotificationSettings* from ../api/admin)
 */
...
export default function NotificationSettings({ user, onNavigate }) {
  return (
    <div>
      {/* Header */}
      <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          หน้านี้จะถูก replace ด้วย V2 page จาก <code style={{
            ...
            fontSize: 12,
            color: MINT_DARK,
          }}>src/pages/NotificationSettings.jsx</code>
        </div>
        ...
        <div style={{
          ...
          <div style={{ color: MINT_MUTED }}>
            Channel token, recipients, toggles per event
          </div>
        </div>
